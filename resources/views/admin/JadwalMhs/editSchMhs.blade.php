...
@section('konten')
    <div class="content-wrapper">
        ...
        <div class="col-xl-6 grid-margin stretch-card flex-column">
            <h5 class="mb-2 text-titlecase mb-4">Edit Jadwal Mahasiswa</h5>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Tambah Jadwal Mahasiswa </h4>
                        ...
                        <form class="forms-sample" method="POST">
                            ...
                            <div class="form-group">
                                <select class="form-select text-black" name="student_id">
                                    <option value="{{ $data->student->id }}">
                                        {{ $data->student->nim . ' | ' . $data->student->name }}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
